...
export default defineUserConfig({
  ...
  theme: recoTheme({
    ...
    navbar: [
      { text: "首页", link: "/" },
      // { text: "作品集", children: [
      //    { text: 'CAD', link: '/categories/html/1' },
      //    { text: '酷家乐', link: '/kujiale/' },
      //    { text: '3DMAX', link: '/3dmax/' },
      // ]},
      // { text: "干货", link: "/tags/tag1/1/" },
      { text: "软件教程", children: [
      ...
      ]},
      {
        text: "联系我",
        children: [
          { text: "小红书", link: "https://www.xiaohongshu.com/user/profile/5d8d90d00000000001005a6e" },
          { text: "微信", link: "/blogs/other/guide" },
        ],
      },
    ],
    // 公告
